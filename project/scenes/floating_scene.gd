...
func initialize(_display: M8SceneDisplay):
	...
	%MeshInstance3D.material_override.set_shader_parameter("tex", _display.m8_client.get_display_texture())
...
func _physics_process(delta):
	...
	%CameraArm.rotation = lerp( %CameraArm.rotation, camera_arm_target_rotation, camera_smoothing)
